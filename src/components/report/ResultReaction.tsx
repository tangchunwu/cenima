    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <Button
          onClick={handleDeny}
          variant="outline"
          className="flex-1 py-6 border-2 border-white/30 bg-white/5 text-white hover:bg-white/10 hover:border-white/50 rounded-xl font-bold text-lg hover:scale-105 transition-transform"
        >
